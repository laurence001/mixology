...
log-normalised token frequency from the political measures sub-corpus
(n = 4,371 tweets, Western Europe, December 2021):

```
weight = 0.5 + (log(freq + 1) / log(max_freq + 1)) × 2.5
```

Range: 0.5 (unseen) to 3.0 (most frequent term, *covid*). Weights can be
